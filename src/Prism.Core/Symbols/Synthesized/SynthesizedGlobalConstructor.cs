    ...
    : FunctionSymbol(CommonNames.GlobalCtor, containingNamespace)
{
    ...
    internal bool ShouldEmit(IReadOnlyList<BoundVariableInitializer> variables)
    {
    ...
    private static bool ComputeShouldEmit(IReadOnlyList<BoundVariableInitializer> variables)
    {
        return variables.Any(variable => variable.Initializer.ConstantValue is null);
    }
}
