...
internal static partial class CommonEnumMappers
{
    ...
    public static SpecialType ToSpecialType(this SyntaxKind kind)
    {
        return kind switch
        {
    ...
    public static UnaryOperation ToPrefixOperation(this SyntaxKind kind)
    {
        return kind switch
        {
    ...
    public static UnaryOperation ToPostfixOperation(this SyntaxKind kind)
    {
        return kind switch
        {
    ...
    public static BinaryOperation ToBinaryOperation(this SyntaxKind kind)
    {
        return kind switch
        {
    ...
    public static AssignmentOperation ToAssignmentOperation(this SyntaxKind kind)
    {
        return kind switch
        {
            ...
            SyntaxKind.GreaterGreaterGreaterEqualToken => AssignmentOperation.UnsignedShiftRight,
