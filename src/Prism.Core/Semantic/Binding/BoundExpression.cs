...
public abstract class BoundExpression : BoundNode
{
    ...
    private protected BoundExpression(SyntaxNode syntax, SemanticModel semanticModel)
...
public sealed class BoundBoolLiteralExpression : BoundExpression
{
    ...
    internal BoundBoolLiteralExpression(SyntaxNode syntax, SemanticModel semanticModel, bool value)
        : base(syntax, semanticModel)
    {
        Value = value;
    }
...
public sealed class BoundIntegerLiteralExpression : BoundExpression
{
    ...
    internal BoundIntegerLiteralExpression(
        SyntaxNode syntax,
        SemanticModel model,
        BigInteger value,
...
public sealed class BoundFloatLiteralExpression : BoundExpression
{
    ...
    internal BoundFloatLiteralExpression(
        SyntaxNode syntax,
        SemanticModel model,
        BigDecimal value,
        FloatSuffix suffix
...
public sealed class BoundStringLiteralExpression : BoundExpression
{
    ...
    internal BoundStringLiteralExpression(SyntaxNode syntax, SemanticModel model, string value)
        : base(syntax, model)
    {
        Value = value;
    }
...
public sealed class BoundVariableExpression : BoundExpression
{
    ...
    internal BoundVariableExpression(ValueSymbol symbol, TypeSymbol type)
        : base(symbol.Declaration.RequireNonNull(), symbol.Compilation.SemanticModel)
    {
        Symbol = symbol;
        Type = type;
    }
...
public sealed class BoundFunctionReferenceExpression : BoundExpression
{
    ...
    internal BoundFunctionReferenceExpression(SyntaxNode syntax, FunctionSymbol function)
        : base(syntax, function.Compilation.SemanticModel)
    {
        Function = function;
    }
}
...
public sealed class BoundOverloadSetExpression : BoundExpression
{
    ...
    internal BoundOverloadSetExpression(
        SyntaxNode syntax,
        SemanticModel semanticModel,
        ImmutableArray<CallableSymbol> functions
    )
        : base(syntax, semanticModel)
    {
        Functions = functions;
...
public sealed class BoundConversionExpression : BoundExpression
{
    ...
    internal BoundConversionExpression(
        ...
        : base(syntax, input.SemanticModel)
    {
        Input = input;
...
public sealed class BoundUnaryExpression : BoundExpression
{
    ...
    internal BoundUnaryExpression(
        ...
        : base(syntax, operand.SemanticModel)
    {
        Type = resultType;
        Operand = operand;
        Operator = @operator;
...
public sealed class BoundBinaryExpression : BoundExpression
{
    ...
    internal BoundBinaryExpression(
        ...
        : base(syntax, left.SemanticModel)
    {
        Left = left;
        Right = right;
        Operator = @operator;
...
public sealed class BoundConditionalExpression : BoundExpression
{
    ...
    internal BoundConditionalExpression(
        ...
        : base(syntax, condition.SemanticModel)
    {
        Condition = condition;
...
public sealed class BoundInvocationExpression : BoundExpression
{
    ...
    internal BoundInvocationExpression(
        SyntaxNode syntax,
        CallableSymbol calledFunction,
        TypeSymbol returnType,
        ImmutableArray<BoundExpression> arguments
    )
        : base(syntax, calledFunction.Compilation.SemanticModel)
    {
